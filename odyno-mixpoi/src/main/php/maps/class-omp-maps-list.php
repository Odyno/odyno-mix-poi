...
if (!class_exists('OMP_Maps_List')) {
  ...
  class OMP_Maps_List extends WP_List_Table {
    ...
    function column_name($item) {
      ...
      function column_utente_id($item) {
          $id=$item['utente_id'];
          $user_info =  get_userdata( $id );
          return get_avatar($id, 32).' '.$user_info->user_login;
      }
    ...
    function get_fuel_data_from_db() {

            $idUtente = get_current_user_id();

      return OMP_Maps_View::get_maps_list_from_db($idUtente);
    }
